...
export const recommendProjectsFlow = ai.defineFlow(
  ...
  async ({objective, projects}) => {
    ...
    const prompt = `
      ...
      The user is Spanish-speaking, so all your reasoning must be in Spanish.
      ...
      The reason should be short, 1-2 sentences, and explain why that specific project is a great fit for the user's interests. The reason must be in Spanish.
