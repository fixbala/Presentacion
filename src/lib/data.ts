...
export const projects: Project[] = [
  {
    ...
    longDescription: 'Desarrollo de un dashboard interactivo que permite la visualización y monitoreo de flujos de datos en tiempo real. Este proyecto utiliza WebSockets para una comunicación bidireccional eficiente y está respaldado por una infraestructura robusta con Spring Boot y Kafka, garantizando un procesamiento de eventos de alto rendimiento y baja latencia.',
  ...
  },
  {
    ...
    longDescription: 'Desarrollo de un API Gateway que actúa como punto de entrada único para una arquitectura de microservicios. Este componente centraliza el enrutamiento de solicitudes, la autenticación y el monitoreo de los diferentes servicios, simplificando la comunicación y mejorando la seguridad y escalabilidad del sistema con Spring Cloud Gateway y Netflix Eureka.',
